...
GAME_IMAGES = {}
GAME_SOUNDS = {}
PLAYER = 'Gallery/Images/aeroplane.png'
BACKGROUND = 'Gallery/Images/background.jpg'
PIPE = 'Gallery/Images/building.png'
...
def welcomeScreen():
    ...
    playery = int((SCREENHEIGHT - GAME_IMAGES['player'].get_height())/1.38)
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('AERODASH BY AKANKSHA')
